...
let message1: string = `my favourite number is ${FavouriteNumbers}`;
...
//question 11
let names1: string[] = ["Mehwish", "Khoula", "Ayesha", "Zoya", "Hafsa"];
...
//question 12
let names: string[] = ["Mehwish", "Khoula", "Ayesha", "Zoya", "Hafsa"];
...
//question 14
let GuestNames1: string[] = ["hina",  "ammara", "bushra"];
GuestNames1.forEach((Guestname) => {
  console.log(
    "Hey!",
    Guestname,
    "I would like to invite you on a dinner at saturday evening"
  );
});

// question 15
let GuestNames2: string[] = ["hina", "sadia", "ammara", "bushra"];
...
console.log(
  `the number of people that were invited to dinner are ${GuestNames.length}`
);

// question 20
let colours: string[] = ["blue", "black", "yellow", "orange", "red"];
...
console.log(
  "Test whether 'grape' is not in the array: !fruits.includes('grape')"
);
...
//question 29
let favourite_fruits: string[] = ["cheeko", "tomato", "grapes"];
...
//question 30, 31
let user_name: string[] = ["admin", "hania", "wara", "sadia", "umer"];
...
//question 34
let favourite_pizza: string[] = ["pepperoni", "pineapple", "tikka"];
for (let i = 0; i < favourite_pizza.length; i++) {
  let element = favourite_pizza[i];
  console.log(`i like ${favourite_pizza} pizza`);
}
console.log(
  "Pizza, a beloved culinary creation, is a versatile dish enjoyed worldwide. With its combination of dough, sauce, cheese, and toppings, pizza offers a delightful fusion of flavors and textures that satisfies cravings and brings people together. i really love pizza"
);

//question 35
let favourite_animal: string[] = ["cat", "dog", "rabbit"];
for (let j = 0; j < favourite_animal.length; j++) {
  console.log(favourite_animal[j]);
}
for (let i = 0; i < favourite_animal.length; i++) {
  if (favourite_animal[i] === "cat") console.log("cats are stubborn");
  else if (favourite_animal[i] === "dog") console.log("i love dogs");
  else console.log("rabbits eat carrots");
}
console.log("any of these animal make a great pet");

//question 36
function make_T_shirt(size: string, message: string): void {
